...
req="ReqClientupdate " & Idclient & ", '" & NomClient & "','" & prenomclient & "','" & NumeroPieceIdentiteClient & "','" & typePieceIdentiteClient & "','" &sexe &"','" & Datenaissanceclient & "','" & Adresseclient & "','" & codepostalclient & "','" & villeclient & "','" & paysclient & "','" & telclient & "','" & emailclient & "'"
