...
req="ReqChambreInsert " & IdHotel & ", " & IdCategorie & ", " & NumeroChambre & ", '" & TelChambre & "', '" & OrientationChambre &"', " & EtageChambre & ", " & NombrePersonnesMax & ", " & NombreLitsEnfant & ", '" & DoucheChambre & "', '" & BaignoireChambre & "', '" & ToiletteChambre & "', '" & ClimChambre & "', '" & TVChambre & "', '" & Refrigerateur & "', '" & BalconChambre & "', '" & VuePiscine & "', '" & VueJardin & "'"
